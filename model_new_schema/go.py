...
class Go(Bioconcept):
    ...
    def __init__(self, biocon_id, display_name, format_name, link, description, 
                 go_go_id, go_aspect, date_created, created_by):
        Bioconcept.__init__(self, biocon_id, 'GO', display_name, format_name, link,
...
class Goevidence(Evidence):
    ...
    def __init__(self, evidence_id, reference_id, source,
        ...
        Evidence.__init__(self, evidence_id, 'GO_EVIDENCE', None, reference_id, None,
